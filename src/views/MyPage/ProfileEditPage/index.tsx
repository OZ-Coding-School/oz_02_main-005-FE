      ...
      <div className="container bg-gray flex-grow pt-[40px] pb-[65px] px-[10px] flex flex-col">
        <div className="flex flex-col flex-grow gap-[40px]">
            ...
            <div className="flex flex-wrap gap-1">
              <div
                ...
                <div className="relative">
                  <Image src="/images/avatar-select.png" alt="select" width={52} height={52} priority />
                </div>
                <input
                  ref={fileInputRef}
                  type="file"
              ...
              {avatars.map((avatar, index) => (
                <div
                  key={index}
                  className={`w-[114px] h-[110px] flex items-center justify-center overflow-hidden cursor-pointer 
          ...
          <div className="px-[10px] mb-[40px]">
            <Button type="xl-full" onClick={handleSaveClick}>
              저장
            </Button>
          </div>
        </div>

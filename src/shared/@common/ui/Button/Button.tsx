...
const Button = ({ type, onClick, children, buttonContents = [], ...props }: ButtonProps) => {
  ...
  const buttonVariants = {
    ...
    'l-rewrite': buttonClassName('w-[346px] h-[44px] text-danger flex justify-center items-center bg-dangerlight rounded-[12px] font-medium hover:bg-dangergray outline outline-1 outline-red-500'),
    'm-line': buttonClassName('w-[155px] h-[55px] text-gray8 outline outline-1 outline-grayc bg-white rounded-[6px] font-medium hover:text-text_primary hover:outline-black'),
    'm-more': buttonClassName('w-[189px] h-[56px] text-white bg-primary rounded-full font-medium hover:bg-gray8'),
    's-more': buttonClassName('w-[104px] h-[40px] text-primary outline outline-1 outline-primary bg-white rounded-full font-medium hover:text-text_primary hover:outline-black'),
    'xs-more': buttonClassName('w-[80px] h-[32px] text-gray8 text-12 outline outline-1 outline-grayc bg-white rounded-full font-medium hover:text-text_primary hover:outline-black'),
    's-full': buttonClassName('w-[100px] h-[40px] text-white bg-primary rounded-[4px] font-medium hover:bg-gray8'),
    'xs-full': buttonClassName('w-[45px] h-[30px] text-12 text-white bg-primary rounded-[4px] font-medium hover:bg-gray8'),
